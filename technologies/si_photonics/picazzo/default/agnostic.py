...
TECH.PPLAYER.WG.CRITICAL = (
    TECH.PPLAYER.WG.TRENCH
    | TECH.PPLAYER.WG.SQUARE
    | TECH.PPLAYER.WG.HOLE
    | TECH.PPLAYER.WG.MARKER
...
# generated layers, not to be used to draw on
TECH.PPLAYER.FC.CRITICAL = (
    TECH.PPLAYER.FC.TRENCH
    | TECH.PPLAYER.FC.SQUARE
    | TECH.PPLAYER.FC.HOLE
...
# generated layers, not to be used to draw on
TECH.PPLAYER.RFC.CRITICAL = (
    TECH.PPLAYER.RFC.TRENCH
    | TECH.PPLAYER.RFC.SQUARE
    | TECH.PPLAYER.RFC.HOLE
...
# generated layers, not to be used to draw on
TECH.PPLAYER.FCW.CRITICAL = (
    TECH.PPLAYER.FCW.LINE
    | (TECH.PPLAYER.FCW.TRENCH ^ TECH.PPLAYER.FCW.DF_AREA) & TECH.PPLAYER.FCW.DF_AREA
)
...
TECH.VFABRICATION.PROCESS_FLOW = VFabricationProcessFlow(
    ...
    [
        ...
        (
            (0, 0, 1, 0, 0),
            TECH.MATERIAL_STACKS.MSTACK_SOI_SI_380nm,
