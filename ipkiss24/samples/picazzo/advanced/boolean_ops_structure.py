...
original_structure = WgMzi1x1Y90Asymmetric(
    separation=20.0, straight1=10.0, straight2=20.0)
...
gl = TECH.PPLAYER.WG.TRENCH | (
    TECH.PPLAYER.WG.LINE ^ TECH.PPLAYER.WG.LF_AREA) & TECH.PPLAYER.WG.LF_AREA
elements_on_generated_layer = get_elements_for_generated_layers(
    elements=original_structure.elements, mapping={gl: TECH.PPLAYER.WG.TEXT})
