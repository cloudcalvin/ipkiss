...
TECH.MATERIALS.AIR = Material(
    name="air", display_style=DisplayStyle(color=COLOR_GREEN))
...
TECH.MATERIALS.InP = Material(
    name="InP", display_style=DisplayStyle(color=COLOR_ORANGE))
TECH.MATERIALS.InGaAsP1p55 = Material(
    name="InGaAsP - Q=1.55", display_style=DisplayStyle(color=COLOR_BLUE))
TECH.MATERIALS.InGaAsP1p2 = Material(
    name="InGaAsP - Q=1.2", display_style=DisplayStyle(color=COLOR_BLACK))
TECH.MATERIALS.BCB = Material(
    name="BCB", display_style=DisplayStyle(color=COLOR_GREEN))
...
MESA_CORE_HEIGHT = LowerCladdingHeight + ActiveLayerHeight + UpperCladdingHeight + Number_of_compensation_stacks * (
    CompensationLayer1Height + CompensationLayer2Height)
...
TECH.MATERIAL_STACKS.MSTACK_BCB = MaterialStack(
    name="BCB",
    materials_heights=[(TECH.MATERIALS.BCB, BONDING_HEIGHT),
                       (TECH.MATERIALS.AIR,
                        AIR_CLADDING_HEIGHT + MESA_CORE_HEIGHT)],
    display_style=DisplayStyle(color=COLOR_WHITE))

TECH.MATERIAL_STACKS.MSTACK_ACLAD = MaterialStack(
    name="ACTIVE CLADDING",
    materials_heights=[
        (TECH.MATERIALS.BCB, BONDING_HEIGHT), (TECH.MATERIALS.InP,
                                               MESA_CLADDING_HEIGHT),
        (TECH.MATERIALS.AIR,
         AIR_CLADDING_HEIGHT + MESA_CORE_HEIGHT - MESA_CLADDING_HEIGHT)
    ],
    display_style=DisplayStyle(color=COLOR_BLACK))

heights = [(TECH.MATERIALS.BCB, BONDING_HEIGHT), (TECH.MATERIALS.InP,
                                                  LowerCladdingHeight),
           (TECH.MATERIALS.InGaAsP1p55,
            ActiveLayerHeight), (TECH.MATERIALS.InP, UpperCladdingHeight)]
...
TECH.MATERIAL_STACKS.MSTACK_ACORE = MaterialStack(
    name="ACTIVE CORE",
