...
TECH.MATERIAL_STACKS.MSTACK_SOI_SI_80nm = MaterialStack(
    ...
    materials_heights=[
        (TECH.MATERIALS.SILICON_OXIDE, MSTACK_SOI_SILICON_OXIDE_HEIGHT),
        (TECH.MATERIALS.SILICON, 0.080), (TECH.MATERIALS.AIR, 0.300 - 0.160)
    ],
...
TECH.MATERIAL_STACKS.MSTACK_SOI_SI_150nm = MaterialStack(
    ...
    materials_heights=[
        (TECH.MATERIALS.SILICON_OXIDE, MSTACK_SOI_SILICON_OXIDE_HEIGHT),
        (TECH.MATERIALS.SILICON, 0.150), (TECH.MATERIALS.AIR, 0.07)
    ],
...
TECH.MATERIAL_STACKS.MSTACK_ACLAD = MaterialStack(
    ...
    materials_heights=[(TECH.MATERIALS.BCB, BONDING_HEIGHT),
                       ...
                       (TECH.MATERIALS.AIR, AIR_CLADDING_HEIGHT +
                        MESA_CORE_HEIGHT - MESA_CLADDING_HEIGHT)],
