...
params["window_size_info"] = SizeInfo(
    west=-62.301, east=-0.01, south=-2.8, north=2.8)
...
params["datacollectors"] = [
    FluxplaneAtPort(
        ...
        port=aperture.west_ports[0],
        name="Flux at input port"), FluxplaneAtPosition(
            center_wavelength=center_wavelength,
            pulse_width=flux_pulse_width,
            number_of_sampling_freq=100,
            position=(-0.01, 0.0),
...
params["stopcriterium"] = RunUntilFieldsDecayedAtProbingPoint(
    ...
    probingpoint=params["datacollectors"][2],
    decay_factor=0.01)
