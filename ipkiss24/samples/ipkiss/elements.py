...
class ElementsExample(Structure):
    def define_elements(self, elems):
        ...
        translation_vector = (lattice_constant / 2.0,
                              sqrt(3) * lattice_constant / 2.0)
        ...
        lattice_vector = (lattice_constant,
                          sqrt(3) * lattice_constant)  #translation in X and Y
        lattice += ARef(
            unit_cell,
            origin=(0.0, 0.0),
        ...
        tic_tac_toe += (
            SRef(nought, (25, -25)) + SRef(nought, (75, -25)) +
            SRef(nought,
                 (125, -75)) + SRef(nought,
                                    (25, -125)) + SRef(nought, (75, -125)))
