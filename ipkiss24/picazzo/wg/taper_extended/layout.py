...
class WgElPortTaperExtended(__WgElPortTaper__):
    ...
    def define_taper(self):
        ...
        # Case: special tapering structures ...
        elif (hasraised and type(
                self.start_port.wg_definition) == RaisedWGFCWgElDefinition
            ...
            taper = RaisedWGFCToWGFCPortTaper(
              ...
              and type(self.start_port.wg_definition) == WGFCWgElDefinition
            ...
            taper = RaisedWGFCToWGFCPortTaper(
                ...
                straight_extension=(self.straight_extension[1],
                                    self.straight_extension[0]))
            taper = Translation(
                translation=self.start_position.move_polar_copy(
                    self.length, self.start_port.angle_deg))(taper)
        elif (hasraised
              and type(self.start_port.wg_definition) == RaisedFCWgElDefinition
            ...
            return RaisedFCToWgElPortTaper(
              ...
              and type(self.start_port.wg_definition) == RaisedWgElDefinition
              ) and (type(self.end_wg_def) == WgElDefinition):
            taper = RaisedWgElToWgElPortTaper(
                ...
                self.start_port.wg_definition) == WgElDefinition):
