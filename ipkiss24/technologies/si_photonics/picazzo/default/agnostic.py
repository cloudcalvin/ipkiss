...
### WG ###
TECH.PPLAYER.WG.TRENCH = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.DF.TRENCH, name="WG_TRE")
TECH.PPLAYER.WG.SQUARE = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.DF.TRENCH, name="WG_SQ")
TECH.PPLAYER.WG.HOLE = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.DF.HOLE, name="WG_HEX")
TECH.PPLAYER.WG.MARKER = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.DF.MARKER, name="WG_MRK")
TECH.PPLAYER.WG.TEXT = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.DF.TEXT, name="WG_TXT")
TECH.PPLAYER.WG.LINE = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.LF.LINE, name="WG_LIN")
TECH.PPLAYER.WG.LF_AREA = PPLayer(
    TECH.PROCESS.WG, TECH.PURPOSE.LF_AREA, name="WG_LFAREA")

# generated layers, not to be used to draw on
TECH.PPLAYER.WG.CRITICAL = TECH.PPLAYER.WG.TRENCH | TECH.PPLAYER.WG.SQUARE | TECH.PPLAYER.WG.HOLE | TECH.PPLAYER.WG.MARKER | (
    TECH.PPLAYER.WG.LINE ^ TECH.PPLAYER.WG.LF_AREA) & TECH.PPLAYER.WG.LF_AREA
TECH.PPLAYER.WG.NONCRITICAL = TECH.PPLAYER.WG.TEXT | TECH.PPLAYER.WG.MARKER
TECH.PPLAYER.WG.SPACE = TECH.PPLAYER.WG.TRENCH | (
    TECH.PPLAYER.WG.LINE ^ TECH.PPLAYER.WG.LF_AREA) & TECH.PPLAYER.WG.LF_AREA
...
### FC ###
TECH.PPLAYER.FC.TRENCH = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.DF.TRENCH, name="FC_TRE")
TECH.PPLAYER.FC.SQUARE = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.DF.TRENCH, name="FC_SQ")
TECH.PPLAYER.FC.HOLE = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.DF.HOLE, name="FC_HEX")
TECH.PPLAYER.FC.MARKER = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.DF.MARKER, name="FC_MRK")
TECH.PPLAYER.FC.TEXT = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.DF.TEXT, name="FC_TXT")
TECH.PPLAYER.FC.LINE = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.LF.LINE, name="FC_LIN")
TECH.PPLAYER.FC.LF_AREA = PPLayer(
    TECH.PROCESS.FC, TECH.PURPOSE.LF_AREA, name="FC_LFAREA")

# generated layers, not to be used to draw on
TECH.PPLAYER.FC.CRITICAL = TECH.PPLAYER.FC.TRENCH | TECH.PPLAYER.FC.SQUARE | TECH.PPLAYER.FC.HOLE | (
    TECH.PPLAYER.FC.LINE ^ TECH.PPLAYER.FC.LF_AREA) & TECH.PPLAYER.FC.LF_AREA
TECH.PPLAYER.FC.NONCRITICAL = TECH.PPLAYER.FC.TEXT | TECH.PPLAYER.FC.MARKER
TECH.PPLAYER.FC.SPACE = TECH.PPLAYER.FC.TRENCH | (
    TECH.PPLAYER.FC.LINE ^ TECH.PPLAYER.FC.LF_AREA) & TECH.PPLAYER.FC.LF_AREA
...
### RFC ###
TECH.PPLAYER.RFC.TRENCH = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.DF.TRENCH, name="RFC_TRE")
TECH.PPLAYER.RFC.SQUARE = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.DF.SQUARE, name="RFC_SQ")
TECH.PPLAYER.RFC.HOLE = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.DF.HOLE, name="RFC_HEX")
TECH.PPLAYER.RFC.MARKER = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.DF.MARKER, name="RFC_MRK")
TECH.PPLAYER.RFC.TEXT = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.DF.TEXT, name="RFC_TXT")
TECH.PPLAYER.RFC.LINE = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.LF.LINE, name="RFC_LIN")
TECH.PPLAYER.RFC.LF_AREA = PPLayer(
    TECH.PROCESS.RFC, TECH.PURPOSE.LF_AREA, name="RFC_LFAREA")

# generated layers, not to be used to draw on
TECH.PPLAYER.RFC.CRITICAL = TECH.PPLAYER.RFC.TRENCH | TECH.PPLAYER.RFC.SQUARE | TECH.PPLAYER.RFC.HOLE | (
    TECH.PPLAYER.RFC.LINE ^ TECH.PPLAYER.RFC.LF_AREA) & TECH.PPLAYER.RFC.LF_AREA
TECH.PPLAYER.RFC.NONCRITICAL = TECH.PPLAYER.RFC.TEXT | TECH.PPLAYER.RFC.MARKER
TECH.PPLAYER.RFC.SPACE = TECH.PPLAYER.RFC.TRENCH | (
    TECH.PPLAYER.RFC.LINE ^ TECH.PPLAYER.RFC.LF_AREA) & TECH.PPLAYER.RFC.LF_AREA
...
### FCW ###
TECH.PPLAYER.FCW.TRENCH = PPLayer(
    TECH.PROCESS.FCW, TECH.PURPOSE.DF.TRENCH, name="FCW_TRE")
TECH.PPLAYER.FCW.MARKER = PPLayer(
    TECH.PROCESS.FCW, TECH.PURPOSE.LF.MARKER, name="FCW_MRK")
TECH.PPLAYER.FCW.TEXT = PPLayer(
    TECH.PROCESS.FCW, TECH.PURPOSE.LF.TEXT, name="FCW_TXT")
TECH.PPLAYER.FCW.LINE = PPLayer(
    TECH.PROCESS.FCW, TECH.PURPOSE.LF.LINE, name="FCW_LIN")
TECH.PPLAYER.FCW.DF_AREA = PPLayer(
    TECH.PROCESS.FCW, TECH.PURPOSE.DF_AREA, name="FCW_DFAREA")

# generated layers, not to be used to draw on
TECH.PPLAYER.FCW.CRITICAL = TECH.PPLAYER.FCW.LINE | (
    TECH.PPLAYER.FCW.TRENCH ^
    TECH.PPLAYER.FCW.DF_AREA) & TECH.PPLAYER.FCW.DF_AREA
...
TECH.GDSII.EXPORT_LAYER_MAP = UnconstrainedGdsiiPPLayerOutputMap(
    process_layer_map=TECH.GDSII.PROCESS_LAYER_MAP,
    purpose_datatype_map=TECH.GDSII.PURPOSE_DATATYPE_MAP)
TECH.GDSII.IMPORT_LAYER_MAP = UnconstrainedGdsiiPPLayerInputMap(
    process_layer_map=TECH.GDSII.PROCESS_LAYER_MAP,
    purpose_datatype_map=TECH.GDSII.PURPOSE_DATATYPE_MAP)

TECH.OPENACCESS.EXPORT_LAYER_MAP = UnconstrainedGdsiiPPLayerOutputMap(
    process_layer_map=TECH.GDSII.PROCESS_LAYER_MAP,
    purpose_datatype_map=TECH.GDSII.PURPOSE_DATATYPE_MAP)
TECH.OPENACCESS.IMPORT_LAYER_MAP = UnconstrainedGdsiiPPLayerInputMap(
    process_layer_map=TECH.GDSII.PROCESS_LAYER_MAP,
    purpose_datatype_map=TECH.GDSII.PURPOSE_DATATYPE_MAP)
...
TECH.MATERIALS.AIR = Material(
    name="air", display_style=DisplayStyle(color=COLOR_GREEN), solid=False)
TECH.MATERIALS.SILICON = Material(
    name="silicon", display_style=DisplayStyle(color=COLOR_CYAN))
...
TECH.MATERIAL_STACKS.MSTACK_SOI_AIR = MaterialStack(
    ...
    materials_heights=[(TECH.MATERIALS.SILICON_OXIDE,
                        MSTACK_SOI_SILICON_OXIDE_HEIGHT), (TECH.MATERIALS.AIR,
                                                           0.380)],
...
TECH.MATERIAL_STACKS.MSTACK_SOI_SI_80nm = MaterialStack(
    ...
    materials_heights=[(TECH.MATERIALS.SILICON_OXIDE,
                       ...
                       (TECH.MATERIALS.SILICON, 0.080), (TECH.MATERIALS.AIR,
                                                         0.300)],
...
TECH.MATERIAL_STACKS.MSTACK_SOI_SI_150nm = MaterialStack(
    ...
    materials_heights=[(TECH.MATERIALS.SILICON_OXIDE,
                        MSTACK_SOI_SILICON_OXIDE_HEIGHT),
                       (TECH.MATERIALS.SILICON, 0.150), (TECH.MATERIALS.AIR,
                                                         0.230)],
...
TECH.MATERIAL_STACKS.MSTACK_SOI_SI_220nm = MaterialStack(
    ...
    materials_heights=[(TECH.MATERIALS.SILICON_OXIDE,
                        MSTACK_SOI_SILICON_OXIDE_HEIGHT),
                       (TECH.MATERIALS.SILICON, 0.220), (TECH.MATERIALS.AIR,
                                                         0.160)],
    display_style=DisplayStyle(color=COLOR_RED))

TECH.MATERIAL_STACKS.MSTACK_SOI_SI_380nm = MaterialStack(
    name="380nm Si",
    materials_heights=[(TECH.MATERIALS.SILICON_OXIDE,
                        MSTACK_SOI_SILICON_OXIDE_HEIGHT),
