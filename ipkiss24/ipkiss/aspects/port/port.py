...
class __AreaPort__(__InPlanePort__):
    ...
    def __eq__(self, other):
        ...
        return (self.area == other.area) and super(__AreaPort__,
                                                   self).__eq__(other)

    def __ne__(self, other):
        return (self.area != other.area) or super(__AreaPort__,
                                                  self).__ne__(other)
...
class __OrientedPort__(Vector, __Port__):
    ...
    def move_copy(self, coordinate):
        return self.__class__(
            position=self.position + coordinate, angle=self.angle_deg)
    ...
    def flip(self):
        ...
        return self.__class__(
            position=self.position, angle=(self.angle_deg + 180.0) % 360.0)
    ...
    def invert_copy(self):
        ...
        return self.__invert_class__(
            position=self.position, angle=self.angle_deg)
