...
def RouteConnectorExpanded(
    ...
    connector_wg_def = WaveguidePointRoundedExpandedConnectElementDefinition(
        wg_definition=wg_def,
...
def RouteConnectorRoundedExpanded(
    route,
    expanded_width=TECH.WG.EXPANDED_WIDTH,
    taper_length=TECH.WG.EXPANDED_TAPER_LENGTH,
    min_wire_length=TECH.WG.SHORT_STRAIGHT,
    ...
    return RouteConnectorExpanded(
        route, expanded_width, taper_length, min_wire_length, process, manhattan=False
    )


def RouteConnectorManhattanExpanded(
    route,
    expanded_width=TECH.WG.EXPANDED_WIDTH,
    taper_length=TECH.WG.EXPANDED_TAPER_LENGTH,
    min_wire_length=TECH.WG.SHORT_STRAIGHT,
    ...
    return RouteConnectorExpanded(
        route, expanded_width, taper_length, min_wire_length, process, manhattan=True
    )
