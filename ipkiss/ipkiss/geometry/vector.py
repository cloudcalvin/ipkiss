...
__all__ = [
    "Vector", "Vector3", "transformation_from_vector",
    "vector_from_two_points", "VectorProperty", "vector_match_transform",
...
class Vector(StrongPropertyInitializer, transformable.Transformable):
    ...
    angle_deg = FunctionProperty(
        get_angle_deg,
        set_angle_deg,
        doc="The outward facing angle of the port.")
    angle = angle_deg
    ...
    def flip(self):
        ...
        return Vector(
            position=self.position, angle=(self.__angle__ + 180.0) % 360.0)
    ...
    def __ne__(self, other):
        return self.position != other.position or (self.angle_deg !=
                                                   other.angle_deg)
...
def transformation_from_vector(vector):
    ...
    return Rotation(
        (0.0, 0.0), vector.angle_deg) + Translation(vector.position)
...
def VectorProperty(internal_member_name=None,
                   restriction=None,
                   preprocess=None,
                   **kwargs):
...
class Vector3(Vector):
    ...
    def __ne__(self, other):
        return self.position != other.position or (
            self.angle_deg != other.angle_deg) or (self.inclination_deg !=
                                                   other.inclination_deg)

    def __repr__(self):
        return "<Vector3 (%f, %f), i=%f, a=%f>" % (self.x, self.y,
