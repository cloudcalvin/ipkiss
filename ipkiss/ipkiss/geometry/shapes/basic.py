...
__all__ = [
    "ShapeArc", "ShapeBend", "ShapeBendRelative", "ShapeCircle", "ShapeCross",
    "ShapeDodecagon", "ShapeEllipse", "ShapeEllipseArc", "ShapeHexagon",
    "ShapeParabolic", "ShapeRadialWedge", "ShapeRectangle",
    "ShapeRegularPolygon", "ShapeRingSegment", "ShapeRoundedRectangle",
    "ShapeRoundedRectangleArc", "ShapeWedge"
]
...
class ShapeWedge(Shape):
    ...
    def define_points(self, pts):
        ...
        pts = [(self.begin_coord[0] + sinangle * self.begin_width / 2.0,
    ...
    def move(self, position):
        self.begin_coord = (self.begin_coord[0] + position[0],
                            self.begin_coord[1] + position[1])
        self.end_coord = (self.end_coord[0] + position[0],
        ...
        if abs(ew - bw) < dx:
            pts.extend(
                [(bc[0] + sinangle * bw / 2.0, bc[1] - cosangle * bw / 2.0),
                 (bc[0] - sinangle * bw / 2.0,
                  bc[1] + cosangle * bw / 2.0), (ec[0] - sinangle * bw / 2.0,
                                                 ec[1] + cosangle * ew / 2.0),
                 (ec[0] + sinangle * bw / 2.0,
                  ec[1] - cosangle * ew / 2.0), (bc[0] + sinangle * bw / 2.0,
