...
class ReferencesExample(Structure):
    def define_elements(self, elems):
        ...
        s = Shape([(10.0, 0.0), (15.0, 10.0), (0.0, 10.0), (0.0, 5.0),
                   (-15.0, 5.0), (-5.0, 0.0), (-10.0, -10.0), (-5.0, -15.0),
                   (10.0, -15.0), (5.0, -10.0), (5.0, -5.0), (10.0, 0.0)])
        ...
        t_abs = NoDistortTransform(
            absolute_rotation=True, absolute_magnification=True)
        ...
        shapes_3_ref = Structure(
            "3_shapes",
            SRef(base_str, (0.0, 0.0)) + SRef(base_str, (50.0, 0.0), t_flip) +
            SRef(base_str, (100.0, 0.0), t_rel) + SRef(base_str,
                                                       (150.0, 0.0), t_abs))

        # Make a fererence to shapes_"_ref, with another transformation
        shapes_3_ref2 = Structure(
            "3_shapes_bis",
            SRef(shapes_3_ref,
                 (0.0, 0.0)) + SRef(shapes_3_ref, (0.0, 100.0), t_flip) + SRef(
                     shapes_3_ref,
                     (0.0, 200.0), t_rel) + SRef(shapes_3_ref,
                                                 (0.0, 300.0), t_abs))

        #create a reference axis
        axis = Structure(
            "axis", Path(
                Layer(2), [(0.0, 300.0), (0.0, 0.0), (300.0, 0.0)], 1))
