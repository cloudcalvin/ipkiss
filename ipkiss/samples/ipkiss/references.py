...
class ReferencesExample(Structure):
    def define_elements(self, elems):
        ...
        t_abs = NoDistortTransform(absolute_rotation=True, absolute_magnification=True)
        ...
        axis = Structure(
            "axis", Path(Layer(2), [(0.0, 300.0), (0.0, 0.0), (300.0, 0.0)], 1)
        )
...
if __name__ == "__main__":
    from ipkiss.primitives.filters.orthogonal_reference_filter import (
        OrthogonalReferenceFilter
    )
