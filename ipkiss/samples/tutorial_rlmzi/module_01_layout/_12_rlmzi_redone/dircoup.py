...
class DirectionalCoupler(Structure):
    ...
    def get_waveguide_routes(self):
        ...
        r1 = Route(
            points=[(0, 0.5 * self.coupler_spacing),
...
class BentDirectionalCoupler(DirectionalCoupler):
    ...
    bend_angle = AngleProperty(
        default=45.0, restriction=RestrictRange(
            0, 90, True,
            True))  # angle between 0 and 90 degrees, including 0 and 90
    straight_after_bend = PositiveNumberProperty(
        default=TECH.WG.SHORT_STRAIGHT)
