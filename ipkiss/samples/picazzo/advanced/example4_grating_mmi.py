...
class GratingMmi(Structure):
    ...
    def define_name(self):
        return "%s_L%d_W%d_P%d_T%d_W%d_T%d" % (
            self.__name_prefix__, self.mmi_length * 1000, self.mmi_width *
            1000, self.grating_pitch * 1000, self.grating_trench_width * 1000,
            self.wg_width * 1000, self.trench_width * 1000)
