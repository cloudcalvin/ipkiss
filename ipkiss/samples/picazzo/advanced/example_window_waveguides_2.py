...
class LshapeWgToWgElDefinitionTaper(__WgElPortTaper__):
    ...
    def define_elements(self, elems):
        ...
        taper_elem5 = Boundary(
            ...
            shape=Shape([(wg_lfarea_window.start_offset, self.length),
                         ...
                         (sign(fc_lfarea_window.end_offset) *
                          (abs(fc_lfarea_window.end_offset)), 0),
                         (fc_lfarea_window.end_offset, 0),
        ...
        taper_elements_transformed = taper_elements.transform_copy(
            transformation=Translation(
                translation=self.start_port.position) + Rotation(
    ...
    def define_ports(self, ports):
        ...
        ports += OutOpticalPort(
            position=(self.start_port.position.x + self.length * cos(
                self.start_port.angle_rad), self.start_port.position.y +
