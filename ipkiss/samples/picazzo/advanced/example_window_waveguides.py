    ...
    def define_windows(self):
        ...
        windows += [
            PathWindow(
                ...
                start_offset=-sign * 0.5 * self.junction_overlap + sign *
                self.junction_offset,
...
class PicazzoExampleWindowWaveguide(Structure):
    def define_elements(self, elems):
        ...
        # define a shape
        my_path_shape = Shape(
            [(0.0, 0.0), (50.0, 0.0), (100.0, 30.0), (150.0, 5.0)])
        ...
        layout += Structure(
            name="wire", elements=[wire_wg_def(shape=my_path_shape)])
        ...
        layout += Structure(
            name="raw", elements=[raw_wg_def(shape=my_path_shape)])
        ...
        ts_wg_def = RaisedWgElDefinition(
            wg_width=0.8,
            trench_width=3.0,
        ...
        layout += Structure(
            name="window", elements=[win_wg_def(shape=my_path_shape)])
