...
my_shallow_ring_tapered = AutoTaperPorts(
...
my_slot_ring = RingRect180DropFilter(
    name="My_Slotted_Ring",
    ring_wg_definition=my_slot_wg,
    coupler_wg_definitions=[my_slot_wg, my_slot_wg],
    coupler_spacings=[0.8, 0.8],
)

my_slot_ring_tapered = AutoTaperPorts(
    structure=my_slot_ring, port_labels=["W0", "E0", "E1"]
)
