...
class MyMMIAWG(__AWGRegularDeMuxDesign__):
    ...
    def define_star_couplers(self):
        ...
        arm_aperture_vectors = aperture_mounting_circular((
            0.0, 0.0), focus, angles)  #0.0, arm_aperture_pitch, self.N_arms+2)
        # output ports
        ...
        sc_in_ports_mmi = ShallowWgApertureMerged(
            vectors=in_port_aperture_vectors,
