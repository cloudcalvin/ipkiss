...
TECH.PROCESS.ACO.wg_lower_z_coord = (
    MSTACK_SOI_SILICON_OXIDE_HEIGHT + 0.22 + BONDING_HEIGHT
)
TECH.PROCESS.ACO.wg_upper_z_coord = (
    MSTACK_SOI_SILICON_OXIDE_HEIGHT + 0.22 + BONDING_HEIGHT + MESA_CORE_HEIGHT
)
...
TECH.MATERIAL_STACKS.MSTACK_BCB = MaterialStack(
    name="BCB",
    materials_heights=[
        (TECH.MATERIALS.BCB, BONDING_HEIGHT),
...
TECH.PROCESS.ACO.wg_lower_z_coord = (
    MSTACK_SOI_SILICON_OXIDE_HEIGHT + 0.220 + BONDING_HEIGHT
)
TECH.PROCESS.ACO.wg_upper_z_coord = (
    MSTACK_SOI_SILICON_OXIDE_HEIGHT + 0.220 + BONDING_HEIGHT + MESA_CORE_HEIGHT
)
...
my_process_flow = VFabricationProcessFlow(
    ...
    is_lf_fabrication={TECH.PROCESS.ACL: False, TECH.PROCESS.ACO: False},
)
