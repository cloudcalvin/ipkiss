...
STD12MM_Column_Bottom_Left = lambda c: (
    STD_IOCOLUMN_Left_Margin + c * STD12MM_Column_Width + c * STD12MM_Column_Spacing,
    0.0,
)
STD12MM_Column_Bottom_Right = lambda c: (
    STD_IOCOLUMN_Left_Margin
    + (c + 1) * STD12MM_Column_Width
    + c * STD12MM_Column_Spacing,
    0.0,
)
...
STD6MM_Column_Bottom_Left = lambda c: (
    STD_IOCOLUMN_Left_Margin + c * STD6MM_Column_Width + c * STD6MM_Column_Spacing,
    0.0,
)
STD6MM_Column_Bottom_Right = lambda c: (
    STD_IOCOLUMN_Left_Margin
    + (c + 1) * STD6MM_Column_Width
    + c * STD6MM_Column_Spacing,
    0.0,
)
...
STD4MM_Column_Bottom_Left = lambda c: (
    STD_IOCOLUMN_Left_Margin + c * STD4MM_Column_Width + c * STD4MM_Column_Spacing,
    0.0,
)
STD4MM_Column_Bottom_Right = lambda c: (
    STD_IOCOLUMN_Left_Margin
    + (c + 1) * STD4MM_Column_Width
    + c * STD4MM_Column_Spacing,
    0.0,
)
...
STD3MM_Column_Bottom_Left = lambda c: (
    STD_IOCOLUMN_Left_Margin + c * STD3MM_Column_Width + c * STD3MM_Column_Spacing,
    0.0,
)
STD3MM_Column_Bottom_Right = lambda c: (
    STD_IOCOLUMN_Left_Margin
    + (c + 1) * STD3MM_Column_Width
    + c * STD3MM_Column_Spacing,
    0.0,
)
...
STD1MM_Column_Bottom_Left = lambda c: (
    STD_IOCOLUMN_Left_Margin + c * STD1MM_Column_Width + c * STD1MM_Column_Spacing,
    0.0,
)
STD1MM_Column_Bottom_Right = lambda c: (
    STD_IOCOLUMN_Left_Margin
    + (c + 1) * STD1MM_Column_Width
    + c * STD1MM_Column_Spacing,
    0.0,
)
