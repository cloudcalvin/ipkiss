...
class TechFibcoupTree(DelayedInitTechnologyTree):
    def initialize(self):
        ...
        def STANDARD_2DGRATING_1550_TE():
            from picazzo.fibcoup.uniform_2d import (
                SymmetricUniformRect2dGrating as _UG2D
            )
            from ipkiss.plugins.photonics.wg.basic import WgElDefinition
            ...
            std1550_2dgrating_trench_overlap = (
                4
            )  # length of overlap between taper and fiber coupler trench
            std1550_2dgrating_dev_angle = (
                3.1
            )  # angle deviation w/respect to 90 degrees.
            G = _UG2D(
                name="std_2dgrating_1550",
