...
def FiberCouplerConcentricCurvedGrating(
    min_r_h,
    min_r_v,
    h_period,
    v_period,
...
def ConcentricCurvedGratingBox(
    min_r_h,
    min_r_v,
    h_period,
    v_period,
...
def FiberCouplerConcentricCurvedGratingBox(
    min_r_h,
    min_r_v,
    h_period,
    v_period,
    ...
    """ Concentric elliptical curved grating fit inside a rectangular box """
    grating = ConcentricCurvedGratingBox(
        min_r_h,
        min_r_v,
        h_period,
        v_period,
...
def ConfocalCurvedGratingBoxGeneric(
...
def FiberCouplerConfocalCurvedGratingBoxGeneric(
    line_widths_positions,
    focus_position,
    box_width,
    socket,
    ...
    grating = ConfocalCurvedGratingBoxGeneric(
        line_widths_positions, focus_position, box_width, v_h_ratio, process=process
    )
    return FiberCouplerGrating(
        socket=socket, socket_position=socket_position, grating=grating
    )
...
def FiberCouplerConfocalCurvedGratingBox(
    min_index,
    h_period,
    v_period,
    n_o_trenches,
...
def ConfocalCurvedGratingBoxApodized(
    min_index,
    h_period,
    v_period,
    n_o_trenches,
...
def FiberCouplerConfocalCurvedGratingBoxApodized(
    min_index,
    h_period,
    v_period,
    n_o_trenches,
...
def MinXConfocalCurvedGratingBox(
    min_x,
    h_period,
    v_period,
    box_length,
    ...
    return ConfocalCurvedGratingBox(
        min_index, h_period, v_period, n_o_trenches, box_width, fill_factor, process
    )


def FiberCouplerMinXConfocalCurvedGratingBox(
    min_x,
    h_period,
    v_period,
    box_length,
...
def AngleConfocalCurvedGratingBox(
    h_period,
    v_period,
    box_length,
    box_width,
    ...
    **kwargs
    ...
    return MinXConfocalCurvedGratingBox(
        min_x,
        h_period,
        v_period,
        box_length,
...
def FiberCouplerAutoConfocalCurvedGratingBox(
    h_period,
    v_period,
    box_length,
    box_width,
    ...
    **kwargs
    ...
    return FiberCouplerGrating(
        socket=socket, socket_position=socket_position, grating=grating, **kwargs
    )


##############################################################
def MinXConfocalCurvedGratingBoxApodized(
    min_x,
    h_period,
    v_period,
    box_length,
...
def AngleConfocalCurvedGratingBoxApodized(
    h_period,
    v_period,
    box_length,
    box_width,
...
def FiberCouplerAutoConfocalCurvedGratingBoxApodized(
    h_period,
    v_period,
    box_length,
    box_width,
