    ...
    def define_elements(self, elems):
        ...
        for i in range(10, 60, 10):
            ...
            tapers += Wedge(
                ...
                end_width=i / 10.0)
            #diagonal taper
            tapers += ParabolicWedge(
                Layer(0), (150 + i, 0), (210 + i, 60), 1.0, i / 10.0)
        ...
        for i in range(5, 30, 5):
            #filled ellipse
            ellipses += Ellipse(
                layer=Layer(0), center=(xpos, 0), box_size=(2 * i, 60))
            #elliptic ring
        ...
        for i in range(5, 50, 5):
            bends += BendPath(
                ...
                line_width=1.5,
                input_angle=60.0,
                output_angle=90.0 + i * 2.0)
            bends += RelativeBendPath(
                layer=Layer(0),
                start_point=(100, 0),
                radius=i,
                line_width=1.5,
                input_angle=60.0,
                angle_amount=30.0 + i * 2.0)
        ...
        for i in range(5, 30, 5):
            ...
            rectangles += Rectangle(
                layer=Layer(0), center=(xpos, 0), box_size=(2 * i, 50))
            #rectangular line 
            rectangles += RectanglePath(
                Layer(0), (xpos, 0), (2 * i + 10, 60), line_width=2.0)
            #filled slightly round rectangle using RoundedRectangle
            rectangles += RoundedRectangle(
                layer=Layer(0),
                center=(xpos, -100),
                box_size=(2 * i, 50),
                radius=1)
            #slightly rounded rectangular line 
            rectangles += RoundedRectanglePath(
                Layer(0), (xpos, -100), (2 * i + 10, 60), 1, 2.0)
            #very slightly round rectangle using RoundedRectangle
            rectangles += RoundedRectangle(
                Layer(0), (xpos, -200), (2 * i, 50), i)
            #very rounded rectangular line 
            rectangles += RoundedRectanglePath(
                Layer(0), (xpos, -200), (2 * i + 10, 60), i, 2.0)
            xpos += 80
        ...
        for i in range(5, 30, 5):
            ...
            boxes += Box(
                layer=Layer(0), center=(xpos + i, 25), box_size=(2 * i, 50))
            xpos += 80
        ...
        for i in range(5, 10):
            ...
            polygons += RegularPolygon(
                layer=Layer(0), center=(xpos, 0), radius=20, n_o_sides=i)
            #regular_polygon line
            polygons += RegularPolygonPath(
                layer=Layer(0),
                center=(xpos, 0),
                radius=30,
                n_o_sides=i,
        ...
        for i in range(5, 25, 5):
            markers += Cross(
                layer=Layer(0), center=(xpos, 0), box_size=40, thickness=i)
            xpos += 60
        ...
        hexagon = Structure(
            "hexagon",
            Hexagon(layer=Layer(0), center=(0.0, 0.0), radius=hexagon_radius))
        ...
        translation_vector = (lattice_constant / 2.0, sqrt(3) *
        ...
        lattice_vector = (lattice_constant, sqrt(3) * lattice_constant
                          )  #translation in X and Y
        lattice += ARef(
            unit_cell,
            origin=(0.0, 0.0),
            period=lattice_vector,
        ...
        # a cross
        cross = Structure("cross", [
            Line(Layer(0), (-15, -15), (15, 15), 6), Line(
                Layer(0), (-15, 15), (15, -15), 6)
        ])
        # noughts and crosses
        tic_tac_toe = Structure("tic_tac_toe")
        tic_tac_toe += Line(Layer(0), (50, 0), (50, -150), 3) + Line(
            Layer(0), (100, 0), (100, -150), 3)  #vertical lines
        tic_tac_toe += Line(Layer(0), (0, -50), (150, -50), 3) + Line(
            Layer(0), (0, -100), (150, -100), 3)  #vertical lines

        tic_tac_toe += (
            SRef(nought, (25, -25)) + SRef(nought, (75, -25)) + SRef(nought, (
                125, -75)) + SRef(nought, (25, -125)) + SRef(nought,
                                                             (75, -125)))
        #references to noughts
        tic_tac_toe += (SRef(cross, (125, -25)) + SRef(cross, (25, -75)) +
                        SRef(cross, (75, -75)) + SRef(cross, (125, -125)))
        ...
        text += Label(
            layer=Layer(0),
            text="TIC-TAC-TOE",
            alignment=(TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP),
            font=0,
            height=30)
        ...
        polygon_text_rotated += PolygonText(
            layer=Layer(0),
            text="ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890(){}[];:.,/\\?!#$%*-+_=<>",
            coordinate=(0.0, -30.0),
            alignment=(TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP),
            font=1,
            height=15,
            transformation=Rotation((0.0, 0.0), -3.0))

        #-------------------------------------------------------------------
        #construct a polygon from scratch
        enterprise = Structure("enterprise")
        coordinates = Shape(
            [(-179, 54), (101, 54), (101, 149), (59, 149), (-11, 172),
             (-39, 209), (-11, 246), (59, 268), (696, 268), (768, 246),
             (795, 209), (768, 172), (696, 149), (147, 149), (147, 54),
             (186, 54), (238, 31), (258, -5), (238, -42), (186, -65),
             (147, -65), (147, -139), (696, -139), (768, -161), (795, -198),
             (768, -235), (696, -258), (59, -258), (-11, -235), (-39, -198),
             (-11, -161), (59, -139), (101, -139), (101, -65), (-179, -65),
             (-179, -100), (-297, -262), (-487, -323), (-678, -262),
             (-795, -100), (-795, 100), (-678, 262), (-487, 323), (-297, 262),
             (-179, 100)],
            closed=True)
