...
params[
    ...
    50
)  # this generates quite a large number of slabs, but apparently CAMFR behaves stable...
...
params["stopcriterium"] = RunUntilFieldsDecayedAtProbingPoint(
    field_component=compHz, probingpoint=params["datacollectors"][2], decay_factor=0.01
)
