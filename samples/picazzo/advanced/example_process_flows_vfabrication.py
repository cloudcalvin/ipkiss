...
TECH.MATERIAL_STACKS.MSTACK_BCB = MaterialStack(
    name="BCB",
    materials_heights=[(TECH.MATERIALS.BCB, 0.480), (TECH.MATERIALS.AIR, 1.3)],
...
class MyRing(Structure):
    ...
    def define_elements(self, elems):
        ...
        elems += Rectangle(
            center=(0.0, 0.0), box_size=(9.0, 9.0), layer=TECH.PPLAYER.ACL.DEFAULT
        )
        elems += Rectangle(
            center=(5.0, 0.0), box_size=(1.0, 2.0), layer=TECH.PPLAYER.ACO.DEFAULT
        )
