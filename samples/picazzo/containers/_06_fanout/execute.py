...
my_ring_fanout = FanoutPorts(
    structure=my_ring, port_labels=["E0", "E1"], output_direction=EAST
)
my_ring_fanout.write_gdsii("fanout_ports_1.gds")

# customizing
my_ring_fanout_2 = FanoutPorts(
    structure=my_ring,
...
my_ring_fanout_3 = FanoutPorts(
    structure=my_ring_fanout, port_labels=["W0", "W1"], output_direction=WEST
)
my_ring_fanout_3.write_gdsii("fanout_ports_3.gds")

# routing in another direction
my_ring_fanout_4 = FanoutPorts(
    structure=my_ring,
...
my_ring_fanout_5 = FanoutPorts(
    structure=my_ring, port_labels=["E0", "E1", "W0", "W1"], output_direction=EAST
)
